...
const Page = () => (
  <article>
      ...
      left={
        <>
          ...
          <ul>
            ...
            <li>Early prototype built with <a href="https://ffmpeg.org/" target="_blank">FFmpeg</a> and <a href="https://kotlinlang.org/docs/multiplatform.html" target="_blank">Kotlin Multiplatform</a></li>
          </ul>
        </>
      }
      right={
        <>
          <h2>Features</h2>
          <ul>
            <li>Record or import videos</li>
            <li>Trim, split, stitch, mute, and re-order videos</li>
            <li>Library of editable, responsive and animated templates</li>
            ...
            <li>Auto-saves projects locally so they can be accessed later</li>
          </ul>
        </>
      }
    />
    ...
    <section>
      ...
      <p>Templates aren&apos;t bundled with the app. Instead, we designed data structures to represent our templates that could be communicated over an API. This data would later be used to dynamically render templates and the UI needed to edit them.</p>
    ...
    <section>
      ...
      <p>Once the user selects a template, it&apos;s corresponding template data is parsed and an in-memory representation of it is constructed as a tree of &quot;nodes&quot;. Whenever a template needs to be rendered on the screen, the app traverses the tree and constructs a hierarchy of <a href="https://developer.apple.com/documentation/quartzcore/calayer" target="_blank"><code>CALayer</code></a>s.</p>
    ...
    <section>
      ...
      <p>The editing capability provided by the template system means that a user can impact the size and position of the elements within the template. For example, adjustments to text, font family and font size all effect the bounding box of the text&apos;s corresponding <a href="https://developer.apple.com/documentation/quartzcore/calayer" target="_blank"><code>CALayer</code></a>.  Futhermore, this has a cascading effect on the expected positions of neighboring elements.</p>
      <p>Since <a href="https://developer.apple.com/documentation/quartzcore/calayer/1410749-layoutmanager" target="_blank"><code>CALayer.layoutManager</code></a> doesn&apos;t exist on iOS, <a href="https://github.com/harterc1/portfolio/blob/master/code-samples/stories-app/LayoutLayer.swift" target="_blank"><code>LayoutLayer</code></a> was created by extending <a href="https://developer.apple.com/documentation/quartzcore/calayer" target="_blank"><code>CALayer</code></a>, a base class that any template element can inherit from to automatically support alignment, padding, and auto-resizing.</p>
